...
export const stringsToTranslate = [
  ...
  "Markup groups were saved into xlsx file.",
  "Markup was created",
  "Markup was deleted",
  ...
  "There are not enough perspectives with expected grouping field.",
  "There is no any perspective with expected grouping field.",
  ...
  "Too large dictionaries to compare",
  "Tools",
  "total",
  "Total items",
  "Total tokens",
