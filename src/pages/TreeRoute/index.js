      ...
      <div>
        <div className="treeRoute">
          ...
          <div className="img-block">
            ...
            <Link to="/dashboard/dictionaries_all">
              <img className="img" src={imageDictionaries} alt="imageDictionaries" />
            </Link>
          </div>
          <div className="img-block">
            <p>{getTranslation('Language corpora')}</p>
            <Link to="/corpora_all">
              <img className="img" src={imageLanguage} alt="imageLanguage" />
            </Link>
          </div>
          <div className="img-block">
            <p>{getTranslation('Bilingual corpora')}</p>
            <Link to="/dashboard/bilingual"> <img className="img" src={image} alt="bilingual" /></Link>
          </div>
        </div>
