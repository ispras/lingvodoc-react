...
function GrantedDicts(props) {
  ...
  const restTree = assignDictsToTree(restDictionaries(dicts, fromJS(grants)), languagesTree);
...
export default compose(withReducer('selected', 'dispatch', selectedReducer, new Set()), graphql(q))(GrantedDicts);
